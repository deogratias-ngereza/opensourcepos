...
class Sales extends Secure_Controller
{
	...
	public function search()
	{
		...
		$filters = array('sale_type' => 'all',
						 ...
						 'is_valid_' => $this->Sale->is_valid_receipt($search));
	...
	public function complete()
	{
		...
		$apply_exchange_rate = $this->sale_lib->is_apply_exchange_rate();
		...
		$data['exchange_rate_set'] = array($apply_exchange_rate, $data['exchange_rate'], $number_locale_alt, $currency_symbol_alt);
	...
	private function _load_sale_data($sale_id, $force_exchange_rate=FALSE)
	{
		...
		error_log('>>> force_exchange_rate-' . $force_exchange_rate);
